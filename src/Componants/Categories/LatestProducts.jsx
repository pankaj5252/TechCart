                ...
                <ul className="list-inline mb-0">
                    ...
                    <div className="col-md-3">
                        <div class="card w-100 border-0 text-center">
                            <img src={mirchi} class="card-img-top category_img" alt="..." />
                            <div class="card-body">
                                <h5 class="card-title">Everest Tikhalal Red Chilli Powder</h5>
                                <p class="card-text">Powdered Spices</p>
                                <b>Rs.62</b>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-3">
                        <div class="card w-100 border-0 text-center">
                            <img src={sambar} class="card-img-top category_img" alt="..." />
                            <div class="card-body">
                                <h5 class="card-title">Everest Tikhalal Red Chilli Powder</h5>
                                <p class="card-text">Powdered Spices</p>
                                <b>Rs.62</b>
